import '../secure-gate-access/server/load-env.js';
import pg from '../secure-gate-access/server/node_modules/pg/lib/index.js';
import { passwordService } from '../secure-gate-access/server/src/services/tokenService.js';
