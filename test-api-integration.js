...
// Check which providers are configured in Render
...
// Main test execution
async function main() {
  await checkRenderConfiguration();
  ...
  if (!mailgunOk && !atOk) {
    ...
    console.log('   Please configure at least one provider in Render environment variables');
  }
