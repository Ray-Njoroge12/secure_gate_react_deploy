    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex gap-2 pb-4">
                ...
                <Button
                    variant={filter === 'sms' ? 'primary' : 'secondary'}
                    size="sm"
                ...
                <Button
                    variant={filter === 'email' ? 'primary' : 'secondary'}
                    size="sm"
                                    ...
                                    <tr key={msg.id} className="hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium ${msg.type === 'sms'
                                                ...
                                                {msg.type === 'sms' ? <Icon name="MessageSquare" className="w-3 h-3" /> : <Icon name="Mail" className="w-3 h-3" />}
