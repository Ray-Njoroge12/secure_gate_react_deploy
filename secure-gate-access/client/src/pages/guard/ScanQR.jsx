            ...
            {scannedData ? (
              <div className="text-center space-y-4">
                ...
                <Card
                  ...
                  className={`border-2 ${scannedData.status === 'success'
                      ? 'border-green-400 bg-green-50'
                      : 'border-red-400 bg-red-50'
                    }`}>
                  <Card.Content className="p-4 md:p-6">
                    <div className="flex flex-col items-center">
                      <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-3 ${scannedData.status === 'success'
                          ? 'bg-green-500'
                          : 'bg-red-500'
                        }`}>
                      ...
                      <h3
                        ...
                        className={`text-xl font-bold mb-2 ${scannedData.status === 'success'
                            ? 'text-green-900'
                            : 'text-red-900'
                          }`}>
                      ...
                      <p
                        ...
                        className={`text-sm md:text-base mb-4 ${scannedData.status === 'success'
                            ? 'text-green-700'
                            : 'text-red-700'
                          }`}>
                        {scannedData.message}
