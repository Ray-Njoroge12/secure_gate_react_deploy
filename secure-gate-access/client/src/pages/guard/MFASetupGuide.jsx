        ...
        <Card.Content className="p-6">
          <div className="flex items-start gap-3">
            <div className="p-2 rounded-lg bg-amber-100 dark:bg-amber-900/30">
              <Icon name="Shield" className="w-6 h-6 text-amber-700 dark:text-amber-300" />
            </div>
            <div>
              <h1 className="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white">MFA Setup Guide</h1>
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">
                Enable multi-factor authentication to protect guard actions such as check-ins,
                check-outs, incident handling, and shift operations.
              </p>
            </div>
          </div>
        </Card.Content>
      ...
      <Card className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700">
        <Card.Content className="p-6 space-y-4">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700 dark:text-gray-200">
            <li>Open Guard Settings and switch to the Security tab.</li>
