      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        ...
        <div className="flex border-b border-gray-200 dark:border-gray-700 mb-6 space-x-1 overflow-x-auto tabs-scroll pb-2">
          {tabs.map((tab) => (
            <button
              ...
              className={`flex items-center gap-2 min-h-[44px] min-w-[44px] px-4 py-2 rounded-lg font-medium cursor-pointer whitespace-nowrap text-sm transition-colors ${
                activeTab === tab.key 
        ...
        {activeTab === "profile" && (
          <form onSubmit={(e) => handleUpdate("Profile", e)} className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">House Number</label>
            ...
            <button type="submit" className={`${btnClass} mt-4`}>Update Profile</button>
          </form>
        )}
        ...
        {activeTab === "password" && (
          <form onSubmit={(e) => handleUpdate("Password", e)} className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-6 space-y-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Update your password for security</p>
            ...
            <button type="submit" className={`${btnClass} mt-4`}>Change Password</button>
          </form>
        )}
        ...
        {activeTab === "security" && (
          <form onSubmit={(e) => handleUpdate("Security", e)} className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-6 space-y-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Configure account security options</p>
            <div className="space-y-4 mt-4">
              ...
              <label className="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600 cursor-pointer hover:border-green-500 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Track and display recent login activity</p>
                </div>
              </label>
            </div>
            <button type="submit" className={`${btnClass} mt-4`}>Save Security Settings</button>
          </form>
        )}
        ...
        {activeTab === "visitorPrefs" && (
          <form onSubmit={(e) => handleUpdate("Visitor Preferences", e)} className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-6 space-y-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Configure default visitor settings</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Default Invite Duration</label>
                <select 
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Max Visitors Per Day</label>
                <input 
                  type="number" 
            ...
            <button type="submit" className={`${btnClass} mt-4`}>Save Visitor Preferences</button>
          </form>
        )}
