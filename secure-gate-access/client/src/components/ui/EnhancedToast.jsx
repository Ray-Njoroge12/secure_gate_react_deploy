...
const ToastIcons = {
  success: <Icon name="check" sizeOverride={20} className="text-green-500" aria-hidden="true" />,
  error: <Icon name="x" sizeOverride={20} className="text-red-500" aria-hidden="true" />,
  warning: <Icon name="alert-triangle" sizeOverride={20} className="text-amber-500" aria-hidden="true" />,
  info: <Icon name="info" sizeOverride={20} className="text-blue-500" aria-hidden="true" />,
};
