  ...
  resident: [
    {
      ...
      badge: null,
      icon: (
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" role="img">
      ...
      >
        ...
        <div className="mb-8">
          <NavLink
            ...
            role="button" // Use button role as this acts as an interactive element
            tabIndex={0}
            onKeyDown={(e) => {
          ...
          >
            <div className="w-8 h-8 bg-brand-600 rounded-lg flex items-center justify-center">
              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" role="img">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
            </div>
        ...
        <div className="mt-auto pt-4 border-t border-gray-200 dark:border-slate-700">
          <Button
            ...
            onClick={onLogout}
            icon={
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" role="img">
